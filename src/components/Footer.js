...
const Footer = () => {
    ...
    return <section id="footer" className="bg-transparent box-border relative h-[70vh] top-0 overflow-hidden">
        <section id="pin-element" className="absolute bottom-0 w-full h-full -translate-y-screen">
            <div id="footer-content-wrapper" className="top-0 relative h-full w-full box-border">
                ...
                <div id="footer-content-inner-wrapper" className="absolute bottom-0 px-5 my-10 h-[70%] max-[500px]:h-[80%] w-full box-border">
                    ...
                    <AnimatedElement trigger='#footer' config={{
                        from: {
                            y: 1000,
                            scale: 1,
                        },
                        ...
                        <div id="footer-cotent-upper" className="flex-[1] items-start justify-center flex flex-row max-[500px]:flex-col">
                            ...
                            <div id="footer-cotent-upper-right" className="flex-[3] max-[500px]:flex-[2] max-[500px]:w-full h-[100%] box-border">
                                <div id="upper-content-right-wrapper" className="box-border w-full h-[100%] flex justify-end">
                                    <div id="inner-content-wrapper" className="w-[70%] max-[500px]:w-full h-full box-border flex flex-col">
                                        <div id="inner-content-upper" className="relative flex items-center justify-center flex-[5]">
                                            ...
                                            <div id="location-map" className="relative flex-[0.75] max-[500px]:flex-[0.5] h-[100%] overflow-hidden w-full rounded-2xl max-[500px]:rounded-lg">
